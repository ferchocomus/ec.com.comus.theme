...
.z-vlayout-inner {
    background-color: #DFEBF5;  <%-- DFEBF5   e8e29b: fercho fvororitos lado izquierdo background--%>
}
...
.desktop-left-column .z-caption, .desktop-left-column .z-caption-content {
    background-color: #805FA2;   <%--COLOR ODONTOLIFE LILA 3A5CAA    azul fercho titulo favoritos--%>
